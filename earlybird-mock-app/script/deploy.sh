...
# create earlybird mock app abi directory
earlybird_mock_app_abi_directory="$CONTRACT_ABI_DIRECTORY/earlybird-examples-abi/earlybird-mock-app-abi"
if [[ ! -d $earlybird_mock_app_abi_directory ]]; then mkdir $earlybird_mock_app_abi_directory; fi

# copy out file to earlybird mock app abi directory
cp -R ../out/. $earlybird_mock_app_abi_directory