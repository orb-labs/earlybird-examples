...
async function useOrDeployMockThunderbirdV1App(expectedMockThunderbirdV1App, earlybirdEndpointAddress) {
    ...
    if ((expectedMockThunderbirdV1AppCode == '0x') && (earlybirdEndpointCode != '0x')) {
        const mockThunderbirdV1AppFactory = new ethers.ContractFactory(mockThunderbirdV1AppFactoryData.abi, mockThunderbirdV1AppFactoryData.bytecode, wallet);
        const mockThunderbirdV1AppContract = await mockThunderbirdV1AppFactory.deploy(earlybirdEndpointAddress, ethers.ZeroAddress);
        ...
        console.log("MockThunderbirdV1App deployed on: %s, at: %s, using earlybird endpoint: %s", CHAIN_NAME, mockThunderbirdV1AppAddress, earlybirdEndpointAddress);
    } else {
        mockThunderbirdV1AppAddress = expectedMockThunderbirdV1App;
        console.log("MockThunderbirdV1App already deployed on: %s, at: %s, using earlybird endpoint: %s", CHAIN_NAME, mockThunderbirdV1AppAddress, earlybirdEndpointAddress);
    }
...
async function useOrDeployMockThunderbirdV1RecsContract(expectedMockThunderbirdV1RecsContract, relayerAddress) {
    ...
    if (expectedMockThunderbirdV1RecsContractCode == '0x') {
        const mockThunderbirdV1RecsContractFactory = new ethers.ContractFactory(mockThunderbirdV1RecsContractFactoryData.abi, mockThunderbirdV1RecsContractFactoryData.bytecode, wallet);
        ...
        console.log("MockThunderbirdV1RecsContract deployed on: %s, at: %s", CHAIN_NAME, mockThunderbirdV1RecsContractAddress);
    } else {
        mockThunderbirdV1RecsContractAddress = expectedMockThunderbirdV1RecsContract;
        console.log("MockThunderbirdV1RecsContract already deployed on: %s, at: %s", CHAIN_NAME, mockThunderbirdV1RecsContractAddress);
    }
...
*/
async function updateConfigsForMockThunderbirdV1App(mockThunderbirdV1App, earlybirdEndpointAddress, appConfigsForSending, appConfigsForReceiving) {
    ...
    if ((mockThunderbirdV1AppCode != '0x') && (earlybirdEndpointCode != '0x')) {
        const earlybirdEndpointContract = new ethers.Contract(earlybirdEndpointAddress, earlybirdEndpointV1FactoryData.abi, provider);
        ...
        if ((currentAppConfigsForSending == appConfigsForSending) && (currentAppConfigsForReceiving == appConfigsForReceiving)) {
            console.log("MockThunderbirdV1App on %s configs already set", CHAIN_NAME);
        } else {
            const mockThunderbirdV1AppContract = new ethers.Contract(mockThunderbirdV1App, mockThunderbirdV1AppFactoryData.abi, wallet);
            const setConfigsTx = await mockThunderbirdV1AppContract.setLibraryAndConfigs("Thunderbird V1", appConfigsForSending, appConfigsForReceiving);
...
async function useOrDeployMockRukhV1App(expectedMockRukhV1App, earlybirdEndpointAddress) {
    ...
    if ((expectedMockRukhV1AppCode == '0x') && (earlybirdEndpointCode != '0x')) {
        const mockRukhV1AppFactory = new ethers.ContractFactory(mockRukhV1AppFactoryData.abi, mockRukhV1AppFactoryData.bytecode, wallet);
        ...
        console.log("MockRukhV1App deployed on: %s, at: %s, using earlybird endpoint: %s", CHAIN_NAME, mockRukhV1AppAddress, earlybirdEndpointAddress);
    } else {
        mockRukhV1AppAddress = expectedMockRukhV1App;
        console.log("MockRukhV1App already deployed on: %s, at: %s, using earlybird endpoint: %s", CHAIN_NAME, mockRukhV1AppAddress, earlybirdEndpointAddress);
    }
...
async function useOrDeployMockRukhV1RecsContract(expectedMockRukhV1RecsContract, relayerAddress) {
    ...
    if (expectedMockRukhV1RecsContractCode == '0x') {
        const mockRukhV1RecsContractFactory = new ethers.ContractFactory(mockRukhV1RecsContractFactoryData.abi, mockRukhV1RecsContractFactoryData.bytecode, wallet);
...
*/
async function updateConfigsForMockRukhV1App(mockRukhV1App, earlybirdEndpointAddress, appConfigsForSending, appConfigsForReceiving) {
    // Check if the mock rukh v1 app exists
    ...
    if ((mockRukhV1AppCode != '0x') && (earlybirdEndpointCode != '0x')) {
        ...
        if ((currentAppConfigsForSending == appConfigsForSending) && (currentAppConfigsForReceiving == appConfigsForReceiving)) {
            ...
            const setConfigsTx = await mockRukhV1AppContract.setLibraryAndConfigs("Rukh V1", appConfigsForSending, appConfigsForReceiving);
            await setConfigsTx.wait();
