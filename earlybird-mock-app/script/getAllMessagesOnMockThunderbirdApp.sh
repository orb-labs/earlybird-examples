...
do
    ...
    echo $expected_mock_thunderbird_app_address_path
    ...
    then
        ...
        export MOCK_THUNDERBIRD_APP_ADDRESS=$expected_mock_thunderbird_app_address
    fi

    forge script deploymentScripts/mockThunderbirdApp/mockThunderbirdApp.s.sol:MockThunderbirdAppGetAllMessages --rpc-url $RPC_URL --broadcast
done