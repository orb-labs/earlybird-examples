// src/Interfaces/IOracle/IOracleForThunderbirdSendModule.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity 0.8.17;

/**
 * @author - Orb Labs
 * @title  - IOracleForThunderbirdSendModule.sol
 * @notice - Interface for Thunderbird library's send module's oracle
 */
interface IOracleForThunderbirdSendModule {
    /**
