// src/Interfaces/IRelayer/IRelayerForRukhSendModule.sol
// SPDX-License-Identifier: UNLICENSED
pragma solidity 0.8.17;

/**
 * @author - Orb Labs
 * @title  - IRelayerForRukhSendModule.sol
 * @notice - Interface for Rukh library's send module's relayer
 */
interface IRelayerForRukhSendModule {
    /**
     ...
     *                            In practice, it is the encoded address of the payment token. Empty for the native token.
