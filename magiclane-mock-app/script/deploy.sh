...
do
    ...
    # fetch file paths
    export MAGICLANE_MOCK_APP_DATA_FILE_PATH="$global_address_dir_path_for_chain/magiclaneMockApp.txt"
    export MAGICLANE_SPOKE_DATA_FILE_PATH="$global_address_dir_path_for_chain/magiclaneSpokeData.txt"
