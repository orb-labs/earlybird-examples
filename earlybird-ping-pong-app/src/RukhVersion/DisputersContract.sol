// src/RukhVersion/DisputersContract.sol
...
contract DisputersContract is IDisputerContractForRukhReceiveModule, Ownable {

    // Address of rukh library receive module
    address public rukhLibraryReceiveModule;

    // Address of app using this as their disputers contract
    address public app;
