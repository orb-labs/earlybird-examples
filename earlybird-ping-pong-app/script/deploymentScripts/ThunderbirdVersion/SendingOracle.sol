...
import "../../../src/ThunderbirdVersion/SendingOracle.sol";
...
contract SendingOracleDeployment is Script {
    function run() external {
        ...
        // expected address
        address expectedThunderbirdVersionPingPongSendingOracleAddress = vm.envAddress(
        ...
        assembly {
            size := extcodesize(expectedThunderbirdVersionPingPongSendingOracleAddress)
        }
