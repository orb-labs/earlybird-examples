...
contract PingPongThunderbirdDeployment is Script {
    function run() external {
        ...
        address expectedThunderbirdVersionPingPongAddress = vm.envAddress(
            "EXPECTED_THUNDERBIRD_VERSION_PINGPONG_ADDRESS"
        );
        ...
        if (size == 0) {
            ...
            PingPong app = new PingPong(
                ...
                address(vm.envAddress("EXPECTED_THUNDERBIRD_VERSION_PINGPONG_SENDING_ORACLE_ADDRESS")),
                address(vm.envAddress("EXPECTED_THUNDERBIRD_VERSION_PINGPONG_SENDING_RELAYER_ADDRESS")),
